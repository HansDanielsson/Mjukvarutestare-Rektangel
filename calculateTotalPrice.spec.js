...
describe('CalculateTotalPrice', () => {
  ...
  it('Köp av 2 produkt', () => {
    cost = calculateTotalPrice(10, 'regular', 2)
    expect(cost).toBe(20)
  })

  it('Köp av regular customer', () => {
    cost = calculateTotalPrice(10, 'regular', 2)
    expect(cost).toBe(20)
  })
  ...
  it('Kontroll att regular får mängdrabatt', () => {
    cost = calculateTotalPrice(10, 'regular', 3)
    expect(cost).toBe(30 * 0.95)
  })

  it('Kontroll att regular får mängdrabatt', () => {
    cost = calculateTotalPrice(10, 'regular', 5)
